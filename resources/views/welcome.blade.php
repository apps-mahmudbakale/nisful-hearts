...
<body>
    ...
    <nav class="bg-white px-2 sm:px-4 py-2.5 dark:bg-gray-900 fixed w-full z-20 top-0 left-0 border-b border-gray-200 dark:border-gray-600">
      ...
      <section class="bg-white dark:bg-gray-900">
        <div class="grid max-w-screen-xl px-4 py-20 mx-auto  lg:gap-8 xl:gap-0 sm:py-20 lg:py-16 lg:grid-cols-12">
            <div class="mr-auto place-self-center lg:col-span-7">
                <h1 class="max-w-2xl mb-4 text-3xl font-bold text-gray-900 tracking-tight sm:text-4xl md:text-4xl dark:text-white">Welcome To Nisful Hearts</h1>
                <p class="max-w-2xl mb-6 font-light text-gray-500 lg:mb-8 md:text-lg lg:text-xl dark:text-gray-400">Welcome to Nisful Hearts, where love is just a click away! Meet new people, find your match and start your love story today!</p>
                <a href="/get-started" class="inline-flex items-center justify-center px-5 py-3 mr-3 text-base font-medium text-center text-white rounded-lg bg-blue-700 hover:bg-primary-800 focus:ring-4 focus:ring-primary-300 dark:focus:ring-primary-900">
                    Get started
            ...
            <div class="hidden lg:mt-0 lg:col-span-5 lg:flex">
                <img src="./Online dating-pana.svg" alt="mockup">
            </div>                
        </div>
    </section>
    <section class="bg-white dark:bg-gray-900">
        <div class="gap-8 items-center py-8 px-4 mx-auto max-w-screen-xl xl:gap-16 md:grid md:grid-cols-2 sm:py-16 lg:px-6">
            <img class="w-full dark:hidden" src="./Online dating-bro.svg" alt="dashboard image">
            ...
            <div class="mt-4 md:mt-0">
                ...
                <a href="/get-started" class="inline-flex items-center text-white bg-primary-700 hover:bg-primary-800 focus:ring-4 focus:ring-primary-300 font-medium rounded-lg text-sm px-5 py-2.5 text-center dark:focus:ring-primary-900">
                    Get started
    ...
    <section class="bg-white dark:bg-gray-900">
        <div class="py-8 px-4 mx-auto max-w-screen-xl sm:py-16 lg:px-6">
            <div class="mb-8 lg:mb-16">
                <h2 class="mb-4 text-4xl tracking-tight content-center md:mx-48 sm:mx-4 font-extrabold text-gray-900 dark:text-white">Designed for business teams like yours</h2>
